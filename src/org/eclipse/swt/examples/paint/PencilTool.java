...
public class PencilTool extends ContinuousPaintSession implements PaintTool {
	 ...
	 */
	public PencilTool(final ToolSettings toolSettings, final PaintSurface paintSurface) {
		super(paintSurface);
	...
	public void render(final Point point) {
		...
		ps.drawFigure(new PointFigure(this.settings.commonForegroundColor, point.x, point.y));
	}
}
