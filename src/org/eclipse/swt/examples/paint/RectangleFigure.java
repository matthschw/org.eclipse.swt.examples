...
public class RectangleFigure extends Figure {
	 ...
	 */
	public RectangleFigure(final Color foregroundColor, final Color backgroundColor, final int lineStyle, final int x1, final int y1, final int x2, final int y2) {
