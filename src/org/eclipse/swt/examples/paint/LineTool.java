...
public class LineTool extends DragPaintSession implements PaintTool {
	 ...
	 */
	public LineTool(final ToolSettings toolSettings, final PaintSurface paintSurface) {
		super(paintSurface);
	...
	protected Figure createFigure(final Point a, final Point b) {
		return new LineFigure(this.settings.commonForegroundColor, this.settings.commonBackgroundColor, this.settings.commonLineStyle,
			a.x, a.y, b.x, b.y);
	}
}
