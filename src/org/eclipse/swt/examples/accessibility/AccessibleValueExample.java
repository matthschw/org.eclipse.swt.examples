...
public class AccessibleValueExample {
	...
	public static void main(final String[] args) {
		...
		canvas.addPaintListener(e -> {
			...
			final Point size = e.gc.stringExtent(val);
		...
		final Accessible accessible = canvas.getAccessible();
		...
		accessible.addAccessibleValueListener(new AccessibleValueAdapter() {
			@Override
			public void setCurrentValue(final AccessibleValueEvent e) {
				value = e.value.intValue();
				canvas.redraw();
			}
			@Override
			public void getMinimumValue(final AccessibleValueEvent e) {
				e.value = Integer.valueOf(min);
			}
			@Override
			public void getMaximumValue(final AccessibleValueEvent e) {
				e.value = Integer.valueOf(max);
			}
			@Override
			public void getCurrentValue(final AccessibleValueEvent e) {
