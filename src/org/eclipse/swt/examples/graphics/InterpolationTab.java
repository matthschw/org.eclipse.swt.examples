...
public InterpolationTab(final GraphicsExample example) {
	super(example);
}
...
public void createControlPanel(final Composite parent) {
	...
	this.imageCb = new Combo(comp, SWT.DROP_DOWN);
	this.imageCb.add(GraphicsExample.getResourceString("House")); //$NON-NLS-1$
	this.imageCb.add(GraphicsExample.getResourceString("Question")); //$NON-NLS-1$
	this.imageCb.add(GraphicsExample.getResourceString("Task")); //$NON-NLS-1$
	this.imageCb.add(GraphicsExample.getResourceString("Font")); //$NON-NLS-1$
	this.imageCb.add(GraphicsExample.getResourceString("Cube")); //$NON-NLS-1$
	this.imageCb.add(GraphicsExample.getResourceString("SWT")); //$NON-NLS-1$
	this.imageCb.add(GraphicsExample.getResourceString("Ovals")); //$NON-NLS-1$
	this.imageCb.select(0);
	this.imageCb.addListener(SWT.Selection, event -> this.example.redraw());
}
