...
public class AdvancedGraphics {
	...
	static Image loadImage (final Device device, final Class<AdvancedGraphics> clazz, final String string) {
	...
	public Shell open(final Display display) {
		...
		final FontData fd = shell.getFont().getFontData()[0];
	...
	public static void main(final String[] args) {
		...
		final Shell shell = new AdvancedGraphics().open(display);
